...
class RectangularRoom(object):
    ...
    def cleanTileAtPosition(self, pos):
        ...
        pos: a Position
        """
        a = math.floor(pos.getX())
        b = math.floor(pos.getY())
        if not (a,b) in self.cleanedtiles:
            self.cleanedtiles.append((a,b))
    ...
    def getRandomPosition(self):
        ...
        """
        a = random.random()*self.width
        b = random.random()*self.height
        return Position(a,b) 
    ...
    def isPositionInRoom(self, pos):
        ...
        """
        return pos.getX() < self.width and pos.getY() < self.height and 0 <= pos.getX() and 0 <= pos.getY()
    ...
    def updatePositionAndClean(self):
        ...
        while True:
            ...
            if self.room.isPositionInRoom(pos):
                ...
                direction = math.floor(random.random()*360)
...
def runSimulation(num_robots, speed, width, height, min_coverage, num_trials,
    ...
    for i in result:
        sum+=i    
    answer = float(sum)/float(len(result))
    return answer
